  ...
  return (
    <div className="flex flex-col items-center mb-6 sm:mb-8 px-4">
      ...
      <div className="relative group mb-4 sm:mb-6">
        ...
        {/* Image Container */}
        <div className="w-[120px] h-[120px] sm:w-[160px] sm:h-[160px] md:w-[200px] md:h-[200px] rounded-full 
          ...
          <div className="w-full h-full rounded-full overflow-hidden 
            ...
            <div className="absolute top-2 right-2 sm:top-4 sm:right-4 z-20">
              <Sparkles size={12} className="text-cyan-300 animate-pulse opacity-0 group-hover:opacity-100 transition-opacity duration-500 sm:w-4 sm:h-4" />
            </div>
            <div className="absolute bottom-4 left-2 sm:bottom-6 sm:left-4 z-20">
              <Music size={10} className="text-blue-300 animate-ping opacity-0 group-hover:opacity-100 transition-opacity duration-700 sm:w-3.5 sm:h-3.5" />
            </div>
        ...
        {/* Floating Elements */}
        <div className="absolute -top-1 -right-1 sm:-top-2 sm:-right-2 w-4 h-4 sm:w-6 sm:h-6 bg-gradient-to-r from-pink-500 to-red-500 
      ...
      <div className="flex items-center justify-center mb-3 sm:mb-4 animate-fade-in-delay-1">
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-transparent bg-clip-text 
        ...
        <div className="relative">
          <BadgeCheck size={28} className="text-cyan-400 fill-blue-500 animate-pulse 
      ...
      <div className="relative mb-4 sm:mb-6">
        <p className="text-sm sm:text-base md:text-lg font-medium text-center
                     px-4 py-2 sm:px-6 sm:py-3 rounded-xl sm:rounded-2xl bg-gradient-to-r from-black/40 via-black/60 to-black/40
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 
                      rounded-xl sm:rounded-2xl blur-xl opacity-0 hover:opacity-100 transition-opacity duration-500 -z-10"></div>
      </div>

      {/* Enhanced Social Links */}
      <div className="flex justify-center gap-4 sm:gap-6 animate-fade-in-delay-2">
        {socialLinks.map((social, index) => (
          <a
            ...
            className={`relative w-12 h-12 sm:w-14 sm:h-14 rounded-xl sm:rounded-2xl bg-gradient-to-br ${social.color}
          ...
          >
            ...
            <social.icon 
              ...
              className="text-white relative z-10 transition-all duration-500 
                         group-hover/icon:scale-110 group-hover/icon:drop-shadow-lg sm:w-6 sm:h-6" 
            />
